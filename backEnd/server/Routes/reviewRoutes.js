...
reviewRouter
  .get('/getall', validateId,validationError,allBookReviews)
  .get('/gettop3', validateId,validationError,topReviews)
...
reviewRouter
  .use(UserAuth)
  .post('/add', addReview)
  .post('/like', validateId,validationError,likeReview)
  .post("/reply", validateId,validationError,replyReview)
  //owners only
  .delete("/delete",validateId,validationError, deleteReview)
  .put("/update",validateId,validationError, updateReview)
  // Admins Only
  .use(AdminAuthorized)
